...
class NBaseDocumentTestCase(TestCase):
    def setUp(self):
        ...
        self.model = ConcreteModel.objects.create(created_by=self.user1, updated_by=self.user1)
    ...
    def test_queryset_filtering(self):
        model2 = ConcreteModel.objects.create(created_by=self.user2, updated_by=self.user2)
        self.model.soft_delete()
